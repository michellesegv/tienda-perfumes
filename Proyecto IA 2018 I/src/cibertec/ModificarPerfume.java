...
public class ModificarPerfume extends JDialog implements ActionListener {
	...
	private JTextField txtAñoLanzamiento;
	...
	public ModificarPerfume() {
		...
		txtAñoLanzamiento = new JTextField(Proyecto.año0 + "");
		txtAñoLanzamiento.setBounds(165, 95, 107, 20);
		getContentPane().add(txtAñoLanzamiento);
		txtAñoLanzamiento.setColumns(10);
	...
	protected void actionPerformedBtnGrabar(ActionEvent e) {
		if (cboNombre.getSelectedIndex() == 0) {
			...
			Proyecto.año0 = Integer.parseInt(txtAñoLanzamiento.getText());
			...
			Proyecto.año1 = Integer.parseInt(txtAñoLanzamiento.getText());
			...
			Proyecto.año2 = Integer.parseInt(txtAñoLanzamiento.getText());
			...
			Proyecto.año3 = Integer.parseInt(txtAñoLanzamiento.getText());
			...
			Proyecto.año4=Integer.parseInt(txtAñoLanzamiento.getText());
