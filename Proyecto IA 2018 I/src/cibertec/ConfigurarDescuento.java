...
public class ConfigurarDescuento extends JDialog implements ActionListener {
	...
	public ConfigurarDescuento() {
		...
		btnAceptar.setBounds(307, 24, 89, 23);
		getContentPane().add(btnAceptar);
		
		btnCancelar = new JButton("Cancelar");
		btnCancelar.addActionListener(this);
		btnCancelar.setBounds(307, 66, 89, 23);
	...
	protected void actionPerformedBtnAceptar(ActionEvent e) {
		Proyecto.porcentaje1=Double.parseDouble(txtUnoACinco.getText());
		Proyecto.porcentaje2=Double.parseDouble(txtSeisADiez.getText());
		Proyecto.porcentaje3=Double.parseDouble(txtOnceAQuince.getText());
		Proyecto.porcentaje4=Double.parseDouble(txtMasDeQuince.getText());
		dispose();
