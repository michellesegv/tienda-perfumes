...
public class ConfigurarObsequio extends JDialog implements ActionListener {
	...
	public ConfigurarObsequio() {
		...
		txtImporteMinimo = new JTextField(Proyecto.importeMinimoObsequiable + "");
		txtImporteMinimo.setBounds(170, 29, 86, 20);
		getContentPane().add(txtImporteMinimo);
		txtImporteMinimo.setColumns(10);
	...
	protected void actionPerformedBtnAceptar(ActionEvent e) {
		Proyecto.importeMinimoObsequiable=Integer.parseInt(txtImporteMinimo.getText());
		Proyecto.obsequio=txtObsequio.getText().toString();
		dispose();
	}
}
