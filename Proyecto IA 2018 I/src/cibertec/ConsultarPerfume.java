...
public class ConsultarPerfume extends JDialog implements ActionListener {
	...
	public ConsultarPerfume() {
		...
		txtAnioLanzamiento = new JTextField(Proyecto.año0 + "");
